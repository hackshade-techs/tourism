  ...
  <div class="container">
    <div class="row">
        ...
        <div class="sidebar">
          ...
          <div class="widget-boxed">
            <div class="widget-boxed-header">
              <h4><i class="ti-check-box padd-r-10"></i>Latest Accomodations</h4>
            </div>
                ...
                <ul class="listing-list">
                  ...
                  <li>
                    ...
                    <div class="listing-list-info">
                      <h5><a href="#" title="Listing">{{ $accomodation->title }}</a></h5>
                      <div class="listing-post-meta">
                        <!-- <span class="updated">{{ $accomodation->created_at }}</span> -->
                        {{ \Carbon\Carbon::parse($accomodation->created_at )->format('d/m/Y')}}
      ...
      <div class="col-md-8 col-sm-12">
        ...
        <div class="row mrg-0">
          @include('composers.accomodation')
